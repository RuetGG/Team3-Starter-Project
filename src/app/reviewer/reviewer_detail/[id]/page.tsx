      ...
      try {
        ...
        if (response.data.data.review_details) {
          setSubmitData({
            id: id,
            activity_check_notes:
              response.data.data.review_details.activity_check_notes || "",
            resume_score: response.data.data.review_details.resume_score || 0,
            essay_why_a2sv_score:
              response.data.data.review_details.essay_why_a2sv_score || 0,
            essay_about_you_score:
              response.data.data.review_details.essay_about_you_score || 0,
            technical_interview_score: 0,
            behavioral_interview_score: 0,
            interview_notes: "",
          });
      ...
      <section>
        ...
        <h1 className="text-2xl font-bold mt-4">
          {fetchError
            ...
            ? "Loading..."
            : `Review: ${
                reviewData?.applicant_details.applicant_name ?? "---------"
              }`}
        </h1>
        ...
        <section className="w-full lg:flex-1 p-10 shadow-lg rounded flex flex-col gap-5">
          ...
          <textarea
            ...
            onChange={(e) =>
              setSubmitData({
                ...submitData,
                activity_check_notes: e.target.value,
              })
            }
