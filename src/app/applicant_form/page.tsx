...
const ApplicantFormPage = () => {
		...
		try {
			...
			const response = await fetch(
				"https://a2sv-application-platform-backend-team3.onrender.com/applications",
				{
					...
					body: formData,
					headers: {
						Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MzJmMmE5Ni0yOTQ1LTQ3ZjItYWVhMS0xYzZkMThlMjAzZDkiLCJleHAiOjE3NTQ5MjEwMTcsInR5cGUiOiJhY2Nlc3MifQ.jeDopfUK_xuycygZUR6oKSikrUO6zgqkB3dfDbkHggo`,
					},
				}
			);
	...
	return (
		<main className="flex flex-col bg-gray-100 text-black items-center min-h-screen p-4">
